...
function(GenerateSourcesFromInput src srcdir dstdir VariantDB outsrclist)
    ...
    if(NOT "${${VariantDB}SourceFilePrefix}" MATCHES "${dstdir}")
      message(FATAL_ERROR "substitution of ${srcdir} by ${dstdir} failed for ${${VariantDB}SourceFilePrefix}")
    endif()
