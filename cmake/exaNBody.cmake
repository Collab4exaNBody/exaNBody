...
macro(exaNBodyStartApplication)
  ...
  if(XNB_ENABLE_HIP)
    ...
    if(XNB_BUILD_CUDA)
      ...
      enable_language(HIP)
      message(STATUS "Exastamp uses HIP ${CMAKE_HIP_COMPILER_VERSION} (arch ${CMAKE_HIP_ARCHITECTURES})")
      set(XSTAMP_CUDA_COMPILE_DEFINITIONS -DXNB_CUDA_VERSION=${CMAKE_HIP_COMPILER_VERSION} -DXNB_HIP_VERSION=${CMAKE_HIP_COMPILER_VERSION})
    endif()
  else()
    set(ONIKA_FORCE_HIP_OPTION ON)
    ...
    if(XNB_BUILD_CUDA)
      ...
      set(XSTAMP_CUDA_COMPILE_DEFINITIONS -DXNB_CUDA_VERSION=${CMAKE_CUDA_COMPILER_VERSION})
