...
macro(exaNBodyStartApplication)
  ...
  # ============ Cuda =================
  # ===================================
  option(XSTAMP_BUILD_CUDA "Enable GPU Acceleration" OFF)
  ...
  if(XNB_ENABLE_HIP)
    ...
    set(ONIKA_USE_HIP ${XSTAMP_BUILD_CUDA})
    if(XSTAMP_BUILD_CUDA)
      ...
      set(XSTAMP_CUDA_COMPILE_DEFINITIONS -DXSTAMP_CUDA_VERSION=${CMAKE_HIP_COMPILER_VERSION})
    endif()
  else()
    set(ONIKA_FORCE_HIP_OPTION ON)
