...
macro(exaNBodyStartApplication)
  ...
  *************\n\
  ...
  set(XNB_COMPILE_DEFINITIONS ${XNB_COMPILE_DEFINITIONS} -DXSTAMP_FIELD_ARRAYS_STORE_COUNT=${XSTAMP_FIELD_ARRAYS_STORE_COUNT})

  set(XNB_INCLUDE_DIRS
    ${ONIKA_INCLUDE_DIRS}
  ...
  set(XNB_LIBRARY_DIRS ${ONIKA_LIBRARY_DIRS})
  set(XNB_CORE_DEPEND_LIBS ${ONIKA_LIBRARIES} ${MPI_CXX_LIBRARIES} ${XNB_APP_LIBRARIES})
  set(XNB_CORE_LIBS exanbCore ${XNB_CORE_DEPEND_LIBS})
