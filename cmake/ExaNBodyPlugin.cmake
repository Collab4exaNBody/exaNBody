...
#    message(STATUS "Plugin ${PluginName}: HOST ${${PluginName}_SCRS} , target=${${PluginName}_DEPS} CUDA ${${PluginName}_SCRS_CU} , target=${${PluginName}_DEPS_CU}")
	...
	# message(STATUS "${CudaKernelTarget} sources => ${${PluginName}_SCRS_CU}")
        ...
        set(${PluginName}_CU_OPTS --std=c++17 --extended-lambda --Werror cross-execution-space-call -ccbin ${CMAKE_CXX_COMPILER} -allow-unsupported-compiler -arch=compute_${XSTAMP_CUDA_ARCH} -code=sm_${XSTAMP_CUDA_ARCH} ${ONIKA_CUDA_USER_FLAGS} --compiler-options ${CUDA_CXX_COMPILER_FLAGS})
