...
#    endif()
    ...
    if(${PluginName}_SCRS_LIB)
      ...
      target_compile_options(${PluginName} PRIVATE ${USTAMP_CXX_FLAGS} ${XSTAMP_PLUGIN_HOST_FLAGS} ${${PluginName}_COMPILE_OPTIONS})
...
#    message(STATUS "Plugin ${PluginName}: HOST ${${PluginName}_SCRS} , target=${${PluginName}_DEPS} CUDA ${${PluginName}_SCRS_CU} , target=${${PluginName}_DEPS_CU}")
    ...
    if(NOT ${PluginName}_HAS_CUDA AND ${PluginName}_SCRS)
      ...
      target_compile_options(${PluginName}Plugin PRIVATE ${USTAMP_CXX_FLAGS} ${XSTAMP_PLUGIN_HOST_FLAGS} ${${PluginName}_COMPILE_OPTIONS})
