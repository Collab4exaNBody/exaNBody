...
macro(xstamp_optional_package PkgName)
  ...
  foreach(enapp ${ARGV})
    if("${enapp}" STREQUAL "${XNB_APP}")
      set(${PkgName}_Enabled ON)
    endif()
  endforeach()
  if(${PkgName}_Enabled)
    message(STATUS "Package ${PkgName} enabled") #  for app ${XNB_APP}
...
macro(xstamp_generate_plugin_database)
  set(XstampV2PluginDBGenCommandBase ${USTAMP_APPS_DIR}/${XNB_APP} ${LoadAllPluginsInputFile} --generate_plugins_db true --logging-debug true)
  MakeRunCommand(XstampV2PluginDBGenCommandBase 1 1 XstampV2PluginDBGenCommand)
  #message(STATUS "gen db command = ${XstampV2PluginDBGenCommand}")
  #set(XstampV2PluginDBGenCommand ${USTAMP_APPS_DIR}/${XNB_APP} ${LoadAllPluginsInputFile} --generate_plugins_db true )
  ...
  get_property(XSTAMP_BUILT_PLUGINS GLOBAL PROPERTY GLOBAL_XSTAMP_BUILT_PLUGINS)
  add_dependencies(UpdatePluginDataBase ${XNB_APP} ${XSTAMP_BUILT_PLUGINS})
  install(FILES ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/plugins_db.msp DESTINATION lib)
endmacro()

macro(xstamp_add_unit_tests)
  set(XStampV2UnitsTestsCommand ${USTAMP_APPS_DIR}/${XNB_APP} ${LoadAllPluginsInputFile} --run_unit_tests true)
