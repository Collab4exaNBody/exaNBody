...
#    message(STATUS "Plugin ${PluginName}: HOST ${${PluginName}_SCRS} , target=${${PluginName}_DEPS} CUDA ${${PluginName}_SCRS_CU} , target=${${PluginName}_DEPS_CU}")
	...
	# message(STATUS "${PluginName}Plugin sources => ${${PluginName}_SCRS_CU}")
...
#        set(${PluginName}_CU_OPTS --std=c++17  -ccbin ${CMAKE_CXX_COMPILER} -allow-unsupported-compiler -arch=compute_${XSTAMP_CUDA_ARCH} -code=sm_${XSTAMP_CUDA_ARCH} ${ONIKA_CUDA_USER_FLAGS} -dc --compiler-options ${CUDA_CXX_COMPILER_FLAGS})
#        set(${PluginName}_CXX_OPTS  ${${PluginName}_COMPILE_OPTIONS})
      	target_compile_options(${PluginName}Plugin PRIVATE ${USTAMP_CXX_FLAGS} $<$<COMPILE_LANGUAGE:CUDA>:--extended-lambda --Werror cross-execution-space-call>)
