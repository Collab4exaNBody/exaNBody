    ...
    inline void execute() override final
    {
      ...
      {        
        ...
        // 2) Test particle/triangle proximity with both acceleration structure and brute force triangle scan
        {
          ...
          ParticleTriangleProjProximity<decltype(check_particle_triangle_a),true,true,false> triv_proximity = { all_triangles , read_only_view(*mesh) , max_dist , check_particle_triangle_a };
          ...
          GridParticleTriangleProjProximity<decltype(check_particle_triangle_b),true,true,false> grid_proximity = { cell_triangles_ro , read_only_view(*mesh) , max_dist , check_particle_triangle_b };
