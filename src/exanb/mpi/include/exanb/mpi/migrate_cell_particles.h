...
#           endif
            ...
            auto* buf_ptr = & (*it);
#           pragma omp task default(none) firstprivate(buf_ptr) shared(grid,opt_data_helper)
            {
              NullLockArray nla;
...
#             pragma omp task default(none) firstprivate(extra_buf) shared(grid,cell_locks_taskyield,extra_recv_buffer_ptrs,extra_rcv_bufs,opt_data_helper)
              {
