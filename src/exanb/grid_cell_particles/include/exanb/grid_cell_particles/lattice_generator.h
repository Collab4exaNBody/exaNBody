...
#       pragma omp parallel
  ...
  public:
    ...
    {
      generate_particle_lattice( *mpi, *bounds_mode, *domain, *grid, *particle_type_map, *particle_regions, *region
                               , *grid_cell_values, *grid_cell_mask_name, *grid_cell_mask_value, *user_function, *user_threshold
                               , *structure, *types, *noise, *size, *noise_cutoff, *shift
                               , *void_mode, *void_center, *void_radius, *void_porosity, *void_mean_diameter );
    }
