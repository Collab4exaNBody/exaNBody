...
namespace exanb
{
  ...
  class ParaviewGenericWriter : public OperatorNode
  {
    ...
    inline void execute_on_fields( const GridFields& ... grid_fields) 
    {
      ...
      ParaviewWriteTools::write_particles(ldbg,*mpi,*grid,grid->cells_accessor(),*domain,*filename,field_selector,*compression,*binary_mode,*write_box,*write_external_box,*write_ghost, grid_fields ... );
    }
