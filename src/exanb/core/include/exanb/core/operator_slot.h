...
template<class T>
inline std::ostream& operator << ( std::ostream& out , const exanb::OperatorSlot<T>& slot )
{
...
#define ADD_SLOT(T,N,D...) OperatorSlot< ::exanb::automatic_slot_type_promotion<T> , GET_FIRST_ARG(D)==::exanb::INPUT > N { this, #N, ::exanb::operator_slot_details::make_operator_slot_construct_args(D) }
