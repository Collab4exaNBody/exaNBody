...
#ifndef XNB_CHUNK_NEIGHBORS_CS_SPE_WITH_XNB_COMMA
#define XNB_CHUNK_NEIGHBORS_CS_SPE_WITH_XNB_COMMA 4 XNB_COMMA 1 XNB_COMMA VARIMPL
#endif

#undef XNB_CHUNK_NEIGHBORS_CS_LIST
#define XNB_CHUNK_NEIGHBORS_CS_LIST XNB_CHUNK_NEIGHBORS_CS_SPE_WITH_XNB_COMMA
