...
namespace exanb
{
  ...
  template<typename GridT> using UpdateGcvFromGhosts = UpdateFromGhosts< GridT , FieldSet<> , UpdateValueAdd , true >;
  ...
  ONIKA_AUTORUN_INIT(update_force_from_ghost)
  {
    ...
    OperatorNodeFactory::instance()->register_factory( "update_opt_from_ghost", make_grid_variant_operator<UpdateOptFromGhosts> );
    ...
    OperatorNodeFactory::instance()->register_factory( "update_opt_from_ghost_no_gcv", make_grid_variant_operator<UpdateOptFromGhostsNoGCV> );
    OperatorNodeFactory::instance()->register_factory( "update_gcv_from_ghost", make_grid_variant_operator<UpdateGcvFromGhosts> );    
  }
