...
XNB_TEXT_ENUM_START(XFormUpdateMode);
XNB_TEXT_ENUM_ITEM(SET);
XNB_TEXT_ENUM_ITEM(PREMULTIPLY);
XNB_TEXT_ENUM_ITEM(POSTMULTIPLY);
XNB_TEXT_ENUM_ITEM(IGNORE);
XNB_TEXT_ENUM_END();

XNB_TEXT_ENUM_YAML(XFormUpdateMode);
